# Load log — public.loans_raw

> GENERATED by `scripts/02_load_raw.py` at 2026-07-19T16:02:00+00:00. Do not hand-edit.

- Source: `data\raw\accepted_2007_to_2018Q4.csv`

## Reconciliation

- Physical lines read (incl. header, incl. multi-line records): **2,260,702**
- Records sent (valid): **2,260,701**
- COPY rowcount: **2,260,701**
- `count(*)` in table: **2,260,701**
- Malformed skipped: **0**
- sent == COPY rowcount == count(*): **verified** (load would have raised otherwise)
- Zero NULLs in loans_raw: **verified**

## Malformed records excluded (complete list)

_None — every record matched the header's field count._
...
- Blank ids: **0** of 2,260,701 (**0.00%**)

## Proof: every source column is present in loans_raw (151)
